...
<body>
    ...
    <style>
        ...
        .search-bar { display: flex; gap: 5px; width: 100%; }
        .search-bar input { padding: 8px; border: 1px solid #ddd; border-radius: 4px; width: 100%; min-width: 0; }
    ...
    <script>
        ...
        function closeSuccessModal() {
            ...
            if (window.successModalCallback) {
                const viewCaseModal = document.getElementById('viewCaseModal');
                if (window.successModalForce || (viewCaseModal && viewCaseModal.style.display === 'block')) {
                    window.successModalCallback();
                }
                window.successModalCallback = null;
            }
            window.successModalForce = false;
        }
        ...
        document.getElementById('addCaseForm').onsubmit = function(e) {
            ...
            fetch('admin_managecases.php', {
                ...
                if (result === 'success') {
                    window.successModalForce = true;
                    showSuccessModal('Case added successfully!', () => {
                        location.reload();
                    });
                } else {
