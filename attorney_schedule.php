...
<body>
    ...
    <style>
        ...
        @media (max-width: 600px) {
            ...
            #eventInfoModal .modal-header {
                padding: 14px 16px !important;
            }
            #eventInfoModal .modal-body {
                padding: 12px 14px !important;
            }
            #eventInfoModal .event-overview {
                flex-direction: column;
                align-items: stretch;
                gap: 12px;
            }
            #eventInfoModal .event-datetime {
                flex-direction: column;
                gap: 8px;
                width: 100%;
            }
            #eventInfoModal .event-details-grid {
                grid-template-columns: 1fr !important;
                gap: 1rem !important;
            }
            #eventInfoModal .detail-section {
                padding: 1rem !important;
            }
            #eventInfoModal .detail-item {
                flex-direction: column;
                align-items: flex-start;
                gap: 4px;
            }
            #eventInfoModal .detail-label,
            #eventInfoModal .detail-value {
                text-align: left;
                max-width: 100%;
                font-size: 0.8rem;
            }
            #eventInfoModal .modal-footer {
                padding: 10px 14px !important;
            }
            #eventInfoModal .btn-close-modal {
                width: 100%;
                justify-content: center;
                font-size: 0.85rem;
            }
        ...
        (function() {
            ...
            window.addEventListener('resize', () => {
                if (!isMobile()) {
                    ...
                    if (sidebarElement) sidebarElement.setAttribute('aria-hidden', 'false');
                    if (mobileNavToggle) {
                    ...
                    sidebarElement.setAttribute('aria-hidden', document.body.classList.contains('sidebar-open') ? 'false' : 'true');
                }
            });

            if (sidebarElement) {
                sidebarElement.setAttribute('aria-hidden', isMobile() ? 'true' : 'false');
            }
        })();
    </script>
<script>
